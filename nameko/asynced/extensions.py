...
class DependencyProvider(Extension):
    ...
    async def get_dependency(self, worker_ctx):
    ...
    async def worker_result(self, worker_ctx, result=None, exc_info=None):
    ...
    async def worker_setup(self, worker_ctx):
    ...
    async def worker_teardown(self, worker_ctx):
...
class ProviderCollector:
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._last_provider_unregistered = self.event_cls()
    ...
    def unregister_provider(self, provider):
        ...
        if len(providers) == 0:
            ...
            self._last_provider_unregistered.set()

    async def wait_for_providers(self):
        ...
        if self._providers_registered:
            ...
            await self._last_provider_unregistered.wait()
